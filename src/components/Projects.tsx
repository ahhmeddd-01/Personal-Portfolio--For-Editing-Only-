...
const projectsData = [
  ...
  },
  {
    ...
    description: "An AI-powered web app that generates stories from user prompts using Hugging Face APIs. Built with Streamlit, it allows real-time customization of story length and creativity through a simple interface.",
    image: "https://res.cloudinary.com/dwqybearh/image/upload/v1748084356/AI-Script-Generator_lvxmuf.webp",
    tags: ["Python", "Hugging Face", "Streamlit", "Intearctive","Accurate"],
    category: "Python",
    demoLink: "https://interactive-story-generator.streamlit.app/",
    githubLink: "https://github.com/ahhmeddd-11/interactive-story-generator/"
  }
];
